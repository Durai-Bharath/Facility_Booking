...
const handleRoomBooking = async (roomName, type) => {
  ...
  try {
    await api.post('/faculty/facilities/book', payload);

    setBookedRoom(roomName);

    alert(
      `Room ${roomName} successfully booked for ${selectedDate} - ${timeSlots[selectedSlotIndex]}`
    );
